    ...
    return (
        <div className="p-8 space-y-8 max-w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-[#161820] border border-[#1E2028] rounded-lg p-6 flex flex-col group hover:border-[#afc6ff]/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        <span className="text-[#8B8D97] text-[13px] font-medium">Interviews</span>
                        <span className="material-symbols-outlined text-[#8B8D97] group-hover:text-[#afc6ff] transition-colors" style={{ fontSize: 20 }}>folder_open</span>
                    </div>
                ...
                <div className="bg-[#161820] border border-[#1E2028] rounded-lg p-6 flex flex-col group hover:border-[#afc6ff]/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="material-symbols-outlined text-[#8B8D97] group-hover:text-[#afc6ff] transition-colors" style={{ fontSize: 20 }}>lightbulb</span>
                    </div>
                    <div className="flex items-baseline gap-2">
                ...
                <div className="bg-[#161820] border border-[#1E2028] rounded-lg p-6 flex flex-col group hover:border-[#afc6ff]/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="material-symbols-outlined text-[#8B8D97] group-hover:text-[#afc6ff] transition-colors" style={{ fontSize: 20 }}>inbox</span>
                    </div>
                    <div className="flex items-baseline gap-2">
                ...
                <div className="bg-[#161820] border border-[#1E2028] rounded-lg p-6 flex flex-col group hover:border-[#afc6ff]/20 transition-all">
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="material-symbols-outlined text-[#8B8D97] group-hover:text-[#afc6ff] transition-colors" style={{ fontSize: 20 }}>trending_up</span>
                    </div>
                    <div className="flex items-baseline gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <section className="lg:col-span-7 bg-[#161820] border border-[#1E2028] rounded-lg overflow-hidden">
                    <div className="flex justify-between items-center px-6 py-5 border-b border-[#1E2028]">
                        ...
                        <a href="/board" className="text-[#afc6ff] text-[13px] font-medium hover:underline flex items-center gap-1">
                            View Board
                    ...
                    <div className="divide-y divide-[#1E2028]">
                        ...
                        <div className="px-6 py-4 flex items-center justify-between hover:bg-white/[0.02] transition-colors">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="px-2 py-0.5 rounded-sm bg-[#afc6ff]/10 text-[#afc6ff] text-[10px] font-bold">12 INTERVIEWS</span>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="px-3 py-1 bg-[#afc6ff]/10 text-[#afc6ff] text-[11px] font-bold rounded-full">HIGH</div>
                            </div>
                        </div>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between hover:bg-white/[0.02] transition-colors">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="px-2 py-0.5 rounded-sm bg-[#afc6ff]/10 text-[#afc6ff] text-[10px] font-bold">8 INTERVIEWS</span>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between hover:bg-white/[0.02] transition-colors">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="px-2 py-0.5 rounded-sm bg-[#afc6ff]/10 text-[#afc6ff] text-[10px] font-bold">15 SIGNALS</span>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between hover:bg-white/[0.02] transition-colors">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="px-2 py-0.5 rounded-sm bg-[#afc6ff]/10 text-[#afc6ff] text-[10px] font-bold">4 FEEDBACK</span>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between hover:bg-white/[0.02] transition-colors">
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="px-2 py-0.5 rounded-sm bg-[#afc6ff]/10 text-[#afc6ff] text-[10px] font-bold">22 TICKETS</span>
                ...
                <section className="lg:col-span-5 bg-[#161820] border border-[#1E2028] rounded-lg overflow-hidden">
                    <div className="flex justify-between items-center px-6 py-5 border-b border-[#1E2028]">
                        ...
                        <a href="/feed" className="text-[#afc6ff] text-[13px] font-medium hover:underline flex items-center gap-1">
                            View Feed
                            <span className="material-symbols-outlined" style={{ fontSize: 16 }}>arrow_forward</span>
                        </a>
                    </div>
                    <div className="px-6 py-6 relative">
                        ...
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-start gap-4 relative">
                                <div className="w-4 h-4 flex-shrink-0 rounded-full bg-[#afc6ff] border-4 border-[#161820] z-10 mt-0.5" />
                                <div className="flex flex-col">
