                    ...
                    <Section title="1. Information We Collect">
                        <SubSection title="1.1 Information You Provide Directly">
                            <ul className="list-disc list-outside pl-5 space-y-2 text-[15px] text-[#B0B2BA]">
                                ...
                                <li><strong className="text-[#F0F0F3]">Integration credentials and data.</strong> When you connect third-party services such as Zendesk or Fireflies, we receive an API key or OAuth token and fetch support ticket or meeting transcript data on your behalf. We only request the minimum permissions necessary.</li>
