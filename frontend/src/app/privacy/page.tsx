                    ...
                    <Section title="1. Information We Collect">
                        <SubSection title="1.1 Information You Provide Directly">
                            <ul className="list-disc list-outside pl-5 space-y-2 text-[15px] text-[#B0B2BA]">
                                ...
                                <li><strong className="text-[#F0F0F3]">Integration credentials and data.</strong> When you connect third-party services such as Zendesk, Fireflies, Otter.ai, or PostHog, we receive an API key or OAuth token and fetch support ticket, meeting transcript, or aggregated analytics data on your behalf. We only request the minimum permissions necessary.</li>
                        ...
                        <SubSection title="1.3 Information from Third Parties">
                            <ul className="list-disc list-outside pl-5 space-y-2 text-[15px] text-[#B0B2BA]">
                                ...
                                <li><strong className="text-[#F0F0F3]">Fireflies.</strong> When you authorise the Fireflies integration, we pull meeting transcript text and metadata (title, date, duration, participant emails, meeting link) into the Service so your meetings appear as interviews. We do not download audio or video recordings, and we never write back to Fireflies.</li>
                                <li><strong className="text-[#F0F0F3]">Otter.ai.</strong> When you authorise the Otter.ai integration, we pull meeting transcript text and metadata (title, date, duration, participant emails, meeting link) into the Service so your meetings appear as interviews. We do not download audio or video recordings, and we never write back to Otter.ai.</li>
                                <li><strong className="text-[#F0F0F3]">PostHog.</strong> When you authorise the PostHog integration, we pull aggregated weekly event counts (event name, week, count) into the Service so usage trends appear alongside your customer evidence. We do not pull raw events, user profiles, or session recordings, and we never write back to PostHog.</li>
